...
$(function () {
    'use strict';
      ...
      var config = {
        ...
        data: {
          ...
          datasets: [{
            ...
            data: [
              44, 66, 98, 79, 80, 64, 86, 68, 79, 80, 62, 67, 87
            ],
          }, {
            label: 'Earning',
            borderColor: '#2494fd',
            ...
            data: [
              40, 60, 90, 70, 80, 60, 80, 60, 70, 80, 60, 70, 70
            ],
          }, {
            label: 'Sales',
            borderColor: '#546aaa',
            ...
            data: [
              14, 66, 97, 73, 87, 68, 83, 65, 78, 89, 60, 73, 74
            ],
          }]
        },
        options: {
      ...
      document.getElementById('randomizeData').addEventListener('click', function() {
        config.data.datasets.forEach(function(dataArr) {
