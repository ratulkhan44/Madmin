// https://codepen.io/claupper/pen/VRBZpM?editors=0010
...
var KanbanTest = new jKanban({
        ...
        buttonClick: function(el, boardId) {
          ...
          formItem.innerHTML =
            '<div class="form-group"><textarea class="form-control" rows="2" autofocus></textarea></div><div class="form-group"><button type="submit" class="btn btn-primary-soft pull-right">Submit</button><button type="button" id="CancelBtn" class="btn btn-default pull-right">Cancel</button></div>';
