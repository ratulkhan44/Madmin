...
$(function() {
  ...
  function cryptoData(dataStats, color) {
    return {
      labels: ["2013", "2014", "2015", "2016", "2017", "2018", "2019", "2021", "2022", "2023", "2025", "2026", "2028"],
      datasets: [{
        label: '# Sales',
        data: dataStats,
        backgroundColor: [
  ...
  if ($("#linechart1").length) {
    ...
    var lineChart = new Chart(lineChartCanvas, {
      type: 'line',
      data: cryptoData([5, 6, 9, 7, 8, 6, 8, 6, 7, 8, 6, 7, 7], 'rgba(7, 191, 88, 0.1)'),
      options: options
    });
  }
  if ($("#linechart2").length) {
    ...
    var lineChart = new Chart(lineChartCanvas, {
      type: 'line',
      data: cryptoData([6, 7, 8, 6, 7, 7, 6, 9, 7, 8, 6, 8, 5], 'rgba(0, 116, 241, 0.1)'),
      options: options
    });
  }
  if ($("#linechart3").length) {
    ...
    var lineChart = new Chart(lineChartCanvas, {
      type: 'line',
      data: cryptoData([3, 6, 4, 7, 6, 6, 4, 6, 5, 4, 6, 5, 7], 'rgba(239, 31, 62, 0.1)'),
      options: options
    });
  }
  if ($("#linechart4").length) {
    ...
    var lineChart = new Chart(lineChartCanvas, {
      type: 'line',
      data: cryptoData([6, 5, 8, 6, 7, 5, 6, 4, 7, 4, 6, 3, 5], 'rgba(255, 191, 0, 0.1)'),
      options: options
    });
  }
});
